...
class BuiltinsMixin:
    def __add__(self, rhs):
        return self.__class__.__getattr__(self, '__add__')(rhs)

    def __str__(self):
        return self.__class__.__getattr__(self, '__str__')()

    def __getitem__(self, i):
        return self.__class__.__getattr__(self, '__getitem__')(i)

    def __call__(self, *args, **kargs):
        return self.__class__.getattr__(self, '__call__')(*args, **kargs)
